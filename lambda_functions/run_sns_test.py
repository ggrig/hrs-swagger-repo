...
# snippet-start:[python.example_code.sns.SetSubscriptionAttributes]
    def add_subscription_filter(subscription, attributes):
        ...
        try:
            ...
            print("Added filter to subscription %s.", subscription.arn)
        except ClientError:
            print(
...
# snippet-start:[python.example_code.sns.Unsubscribe]
    def delete_subscription(subscription):
        ...
        try:
            subscription.delete()
            print("Deleted subscription %s.", subscription.arn)
        except ClientError:
            print("Couldn't delete subscription %s.", subscription.arn)
            raise
