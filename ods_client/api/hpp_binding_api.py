...
class HPPBindingApi(object):
    ...
    def insert_payment_pc(self, body, **kwargs):  # noqa: E501
        """InsertPaymentPC  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.insert_payment_pc(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param InsertPaymentPCBody body: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.insert_payment_pc_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.insert_payment_pc_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def insert_payment_pc_with_http_info(self, body, **kwargs):  # noqa: E501
        """InsertPaymentPC  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.insert_payment_pc_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method insert_payment_pc" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `insert_payment_pc`")  # noqa: E501
